...
export default props => {
  ...
  return (
    <AlbumInfoContainer>
      ...
      <AlbumContents>
        <Content>앨범명 : {albumDetail.title}</Content>
        <Content>발매일 : {albumDetail.saleDate}</Content>
        <Content>아티스트 : {albumDetail.artist}</Content>
        <Content>장르 : {albumDetail.genre}</Content>
        <Content>기획사 : {albumDetail.planingCompany}</Content>
        <Tracks>
          <Subject>수록곡</Subject>
          {albumDetail.songs
